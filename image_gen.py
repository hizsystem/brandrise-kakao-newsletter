...
def generate_prompts_batch(
    ...
    try:
        ...
        _prompt = (
            ...
            "  'top-down flat vector view of a TV screen displaying a soccer field with bright blue accent border, a rounded delivery box with crown icon beside it, remote control, and coins on clean off-white background'\n"
            "- '네이버 치지직 광고 도입' (본문: 스트리밍 중 배너 광고 삽입 테스트) →\n"
            "  'angled view of a flat monitor with rounded corners and play button in bright blue #3182F6, a flowing banner ribbon, stacked coins and headset nearby, soft shadows on off-white background'\n"
            "- 'GS25, 라면 특화 매장 오픈' (본문: 100여 종 라면 진열, 즉석 조리대) →\n"
            "  'elevated perspective of convenience store shelves with colorful ramen boxes neatly arranged, a simple bowl and chopsticks in foreground, kettle to the side, flat vector with gentle shadows on plain off-white'\n\n"
            "나쁜 예 (절대 이렇게 만들지 말 것):\n"
